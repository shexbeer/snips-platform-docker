...
MQTT_BROKER_ADDRESS = "192.168.179.11:1883"
MQTT_USERNAME = "mqtt"
MQTT_PASSWORD = "mqtt"
...
def subscribe_intent_callback(hermes, intent_message):
    ...
    if intentname == user_intent("currentDate"):
        ...
        hours = datetime.datetime.now().astimezone(timezone('Europe/Berlin')).hour
...
if __name__ == "__main__":
    logging.info("Action Datum und Uhrzeit connected")
